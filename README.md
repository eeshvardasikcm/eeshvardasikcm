...
* [My new designs](https://github.com/eeshvardasikcm/cpp-how-to/precision-performance.md). A recent new proposal meant for rust, had the effect of me desiring to enter that discreet domain, even if not publicly This study  appears to have been going on for some time. Happy to be able to begin answering some of the thoughts that are still issues faced today in rust SIMD.
