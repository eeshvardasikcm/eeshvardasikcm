...
* [My new designs](https://github.com/eeshvardasikcm/unstoppable_simd). A recent new proposal had the effect of me desiring to help fearless SIMD. This study in fearless SIMD appears to have been going on since 2018. Happy to be able to begin answering some of the thoughts from 2018 that are still active today in rust SIMD.
