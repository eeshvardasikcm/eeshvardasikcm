...
ayurproject-dev repository was made a private repository recently. I have caused me to seriously reevaluated how I post publicly and I have drastically changed my public appearance in efforts to make my career go as good as possible, and for the future of my lifetime Ayurveda and Project Management app.
...
The ayurproject-dev GitHub repository were created with the intention of involving the open source community with the development of AyurProject at some partial levels of public development exposure.

It is currently a goal to resurface the ayurproject-dev repository as a new Ayurveda and Project Management repository, likely with major redactions squashing many previous commits, and hiding many previous comments.

Ayurveda and Project Management is privately owned by myself and I am the sole designer and developer. Most of Ayurveda and Project Management will be published straight to my private Google Cloud. From there, my Ayurveda and Project Management artifacts will generate the web app and the Android app. The Windows version is in development and is farther along than the Android and web versions. The Windoes version will be applied for publishing to the Epic Games Store.
